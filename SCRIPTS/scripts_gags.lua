...
local citizenList   = {
    ...
    ,"(Barbo|Barbus|Bartolomeo|Baudemundus|Benevenuta|Benghi|Bertucio|Blancha|Boio|Bolezino|Borbrator|Brother|Bucello) ("..citizenemotes..")"
    ,"(Barbo|Barbus|Bartolomeo|Baudemundus|Benevenuta|Benghi|Bertucio|Blancha|Boio|Bolezino|Borbrator|Brother|Bucello) ("..citizenspeaks..")"
    ...
    ,"(Odwinus|Oliverio|Ooll) ("..citizenemotes..")"
    ,"(Odwinus|Oliverio|Ooll) ("..citizenspeaks..")"
