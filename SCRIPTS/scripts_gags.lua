...
local citizenList   = {
    ...
    ,"(Claricia|Colette|Colleta) ("..citizenemotes..")"
    ,"(Claricia|Colette|Colleta) ("..citizenspeaks..")"
    ...
    ,"(Rambaldo|Richa|Rigi|Romano|Rogerus|Ryuji) ("..citizenemotes..")"
    ,"(Rambaldo|Richa|Rigi|Romano|Rogerus|Ryuji) ("..citizenspeaks..")"
