...
local citizenList   = {
    ...
    ,"(Agneta|Agostino|Ai|Aiko|Alberea|Alegreza|Almaricus|Aluysio|Andrea|Arizzo|Ascelina|Aya) ("..citizenemotes..")"
    ,"(Agneta|Agostino|Ai|Aiko|Alberea|Alegreza|Almaricus|Aluysio|Andrea|Arizzo|Ascelina|Aya) ("..citizenspeaks..")"
    ...
    ,"(Gerita|Gerolimo|Giacomo|Girardus|Girout|Gregorio|Guillelmus) ("..citizenemotes..")"
    ,"(Gerita|Gerolimo|Giacomo|Girardus|Girout|Gregorio|Guillelmus) ("..citizenspeaks..")"
    ...
    ,"(Kasumi) ("..citizenemotes..")"
    ,"(Kasumi) ("..citizenspeaks..")"
    ,"(Lambertus|Lorenzo|Luca|Lucha|Luciana) ("..citizenemotes..")"
    ,"(Lambertus|Lorenzo|Luca|Lucha|Luciana) ("..citizenspeaks..")"
    ...
    ,"(Scabor|Sedilia|Seimei|Shinobu|Simon|Staji) ("..citizenemotes..")"
    ,"(Scabor|Sedilia|Seimei|Shinobu|Simon|Staji) ("..citizenspeaks..")"
