...
local citizenemotes = "blinks|bows|chuckles|fixes|flees|frowns|giggles|glares|grins|hums|looks|"
citizenemotes = citizenemotes.."nods|peers|ponders|screams|shakes|sighs|smiles|smirks|stares|stretches|swings|twiddles|whistles|yawns"
...
local citizenList   = {
    ...
    ,"(Agnesina|Agneta|Agostino|Ai|Aiko|Alardus|Aldgislo|Alberea|Alegreza|Alesia|Alfgard|Alfsuind|Almaricus|Aluysio|Andrea|Andream|Anechino|Arizzo|Arnulphus|Ascelina|Auburgis|Ava|Avelina|Aya) ("..citizenemotes..")"
    ,"(Agnesina|Agneta|Agostino|Ai|Aiko|Alardus|Aldgislo|Alberea|Alegreza|Alesia|Alfgard|Alfsuind|Almaricus|Aluysio|Andrea|Andream|Anechino|Arizzo|Arnulphus|Ascelina|Auburgis|Ava|Avelina|Aya) ("..citizenspeaks..")"
    ,"(Banager|Barbo|Barbus|Bartolomeo|Baudemundus|Benevenuta|Benghi|Bertucio|Blancha|Boio|Bolezino|Borbrator|Brother|Bucello) ("..citizenemotes..")"
    ,"(Banager|Barbo|Barbus|Bartolomeo|Baudemundus|Benevenuta|Benghi|Bertucio|Blancha|Boio|Bolezino|Borbrator|Brother|Bucello) ("..citizenspeaks..")"
    ,"(Catarina|Caterucia|Claricia|Colette|Colleta) ("..citizenemotes..")"
    ,"(Catarina|Caterucia|Claricia|Colette|Colleta) ("..citizenspeaks..")"
    ,"(Dai|Daigoro|Danieli|Dyonisius) ("..citizenemotes..")"
    ,"(Dai|Daigoro|Danieli|Dyonisius) ("..citizenspeaks..")"
    ,"(Edelina|Engris|Erlewino|Ermengardis|Ernulfi|Erradi|Eswar|Eustachius|Evrardus) ("..citizenemotes..")"
    ,"(Edelina|Engris|Erlewino|Ermengardis|Ernulfi|Erradi|Eswar|Eustachius|Evrardus) ("..citizenspeaks..")"
    ,"(Federico|Felle|Fiora|Flaminio|Florentia|Flos|Fokka|Folcbaldo|Francescino|Francesco|Fresbertus) ("..citizenemotes..")"
    ,"(Federico|Felle|Fiora|Flaminio|Florentia|Flos|Fokka|Folcbaldo|Francescino|Francesco|Fresbertus) ("..citizenspeaks..")"
    ,"(Gelmarus|Gerita|Gerolimo|Giacomo|Girardus|Girout|Godile|Goduuara|Gregorio|Guiburgis|Guillelmus|Gundrada) ("..citizenemotes..")"
    ,"(Gelmarus|Gerita|Gerolimo|Giacomo|Girardus|Girout|Godile|Goduuara|Gregorio|Guiburgis|Guillelmus|Gundrada) ("..citizenspeaks..")"
    ,"(Hakji|Hathaburch|Hayato|Hecelina|Heio|Helena|Heleuuit|Helloysis|Heloysis|Helyoudis|Hersendis|Hildemunde|Hodeardis) ("..citizenemotes..")"
    ,"(Hakji|Hathaburch|Hayato|Hecelina|Heio|Helena|Heleuuit|Helloysis|Heloysis|Helyoudis|Hersendis|Hildemunde|Hodeardis) ("..citizenspeaks..")"
    ,"(Ienobu|Itkkitk|Ivo) ("..citizenemotes..")"
    ,"(Ienobu|Itkkitk|Ivo) ("..citizenspeaks..")"
    ,"(Jacobus) ("..citizenemotes..")"
    ,"(Jacobus) ("..citizenspeaks..")"
    ,"(Kasumi|Kentaro|Kirika) ("..citizenemotes..")"
    ,"(Kasumi|Kentaro|Kirika) ("..citizenspeaks..")"
    ,"(Lambertus|Lancelinus|Lebewinus|Leduualdus|Leonardo|Leonius|Liuduuih|Lorenzo|Luca|Lucha|Lucia|Luciana) ("..citizenemotes..")"
    ,"(Lambertus|Lancelinus|Lebewinus|Leduualdus|Leonardo|Leonius|Liuduuih|Lorenzo|Luca|Lucha|Lucia|Luciana) ("..citizenspeaks..")"
    ,"(Manteti|Maria|Martino|Matio|Meddin|Meginhild|Meginsuind|Michaleto|Micola|Mirabae|Moonoolool|Multormuh) ("..citizenemotes..")"
    ,"(Manteti|Maria|Martino|Matio|Meddin|Meginhild|Meginsuind|Michaleto|Micola|Mirabae|Moonoolool|Multormuh) ("..citizenspeaks..")"
    ,"(Nami|Nasih|Nicoleto|Nodelend) ("..citizenemotes..")"
    ,"(Nami|Nasih|Nicoleto|Nodelend) ("..citizenspeaks..")"
    ,"(Odwinus|Oliverio|Ooll|Othilhildis) ("..citizenemotes..")"
    ,"(Odwinus|Oliverio|Ooll|Othilhildis) ("..citizenspeaks..")"
    ,"(Paolo|Pasqualina|Pencina|Pero|Petronilla|Piruza) ("..citizenemotes..")"
    ,"(Paolo|Pasqualina|Pencina|Pero|Petronilla|Piruza) ("..citizenspeaks..")"
    ,"(Raingerus|Rambaldo|Renodus|Richa|Righi|Rigi|Rikuuard|Romano|Rogerus|Ryuji) ("..citizenemotes..")"
    ,"(Raingerus|Rambaldo|Renodus|Richa|Righi|Rigi|Rikuuard|Romano|Rogerus|Ryuji) ("..citizenspeaks..")"
    ,"(Scabor|Scalortormut|Sedilia|Segecin|Seimei|Shinobu|Shun|Simon|Staji) ("..citizenemotes..")"
    ,"(Scabor|Scalortormut|Sedilia|Segecin|Seimei|Shinobu|Shun|Simon|Staji) ("..citizenspeaks..")"
    ,"(Tadhild|Tarvixio|Tetmarus|Tetsu|Thadeo|Thalia|Thiadmar|Thiadulf|Thiatgif|Thomas|Thomisina|Tirna|Tor|Tsukasa|Tuscus) ("..citizenemotes..")"
    ,"(Tadhild|Tarvixio|Tetmarus|Tetsu|Thadeo|Thalia|Thiadmar|Thiadulf|Thiatgif|Thomas|Thomisina|Tirna|Tor|Tsukasa|Tuscus) ("..citizenspeaks..")"
    ,"(Uguccio|Un|Uuiduco) ("..citizenemotes..")"
    ,"(Uguccio|Un|Uuiduco) ("..citizenspeaks..")"
    ,"(Vitaliano|Vualdbrehitus|Vuendelgrimi|Vulfiardis) ("..citizenemotes..")"
    ,"(Vitaliano|Vualdbrehitus|Vuendelgrimi|Vulfiardis) ("..citizenspeaks..")"
    ,"(Wakil|Wendelburgis|Wersuent|Wicswint|Wigmanni) ("..citizenemotes..")"
    ,"(Wakil|Weldelburgis|Wersuent|Wicswint|Wigmanni) ("..citizenspeaks..")"
