...
local citizenList   = {
    ...
    ,"(Hakji|Hayato|Hecelina|Helena|Helloysis|Heloysis|Hersendis|Hodeardis) ("..citizenemotes..")"
    ,"(Hakji|Hayato|Hecelina|Helena|Helloysis|Heloysis|Hersendis|Hodeardis) ("..citizenspeaks..")"
    ...
    ,"(Maria|Martino|Matio|Micola|Mirabae|Moonoolool|Multormuh) ("..citizenemotes..")"
    ,"(Maria|Martino|Matio|Micola|Mirabae|Moonoolool|Multormuh) ("..citizenspeaks..")"
    ,"(Nami|Nasih) ("..citizenemotes..")"
    ,"(Nami|Nasih) ("..citizenspeaks..")"
    ,"(Oliverio|Ooll) ("..citizenemotes..")"
    ,"(Oliverio|Ooll) ("..citizenspeaks..")"
    ,"(Paolo|Pasqualina|Pencina|Petronilla|Piruza) ("..citizenemotes..")"
    ,"(Paolo|Pasqualina|Pencina|Petronilla|Piruza) ("..citizenspeaks..")"
    ...
    ,"(Tarvixio|Tetsu|Thadeo|Thalia|Thomas|Thomisina|Tirna|Tor|Tsukasa|Tuscus) ("..citizenemotes..")"
    ,"(Tarvixio|Tetsu|Thadeo|Thalia|Thomas|Thomisina|Tirna|Tor|Tsukasa|Tuscus) ("..citizenspeaks..")"
    ,"(Un) ("..citizenemotes..")"
    ,"(Un) ("..citizenspeaks..")"
