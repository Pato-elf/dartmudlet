...
local citizenList   = {
    ...
    ,"(Hecelina|Helena|Helloysis|Heloysis|Hersendis) ("..citizenemotes..")"
    ,"(Hecelina|Helena|Helloysis|Heloysis|Hersendis) ("..citizenspeaks..")"
    ...
    ,"(Matio|Micola|Mirabae|Multormuh) ("..citizenemotes..")"
    ,"(Matio|Micola|Mirabae|Multormuh) ("..citizenspeaks..")"
    ,"(Nasih) ("..citizenemotes..")"
    ,"(Nasih) ("..citizenspeaks..")"
