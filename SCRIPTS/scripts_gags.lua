...
local citizenList   = {
    ...
    ,"(Federico|Felle|Fiora|Flaminio|Florentia|Flos|Fokka|Folcbaldo|Francescino|Fresbertus) ("..citizenemotes..")"
    ,"(Federico|Felle|Fiora|Flaminio|Florentia|Flos|Fokka|Folcbaldo|Francescino|Fresbertus) ("..citizenspeaks..")"
