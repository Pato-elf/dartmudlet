...
local citizenList   = {
    ...
    ,"(Federico|Felle|Fiora|Flaminio|Florentina|Flos|Francescino) ("..citizenemotes..")"
    ,"(Federico|Felle|Fiora|Flaminio|Florentina|Flos|Francescino) ("..citizenspeaks..")"
    ...
    ,"(Maria|Matio|Micola|Mirabae|Moonoolool|Multormuh) ("..citizenemotes..")"
    ,"(Maria|Matio|Micola|Mirabae|Moonoolool|Multormuh) ("..citizenspeaks..")"
