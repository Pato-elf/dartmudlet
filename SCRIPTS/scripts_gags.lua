...
local citizenList   = {
    ...
    ,"(Agneta|Ai|Aiko|Alberea|Alegreza|Aluysio|Andrea|Arizzo|Ascelina|Aya) ("..citizenemotes..")"
    ,"(Agneta|Ai|Aiko|Alberea|Alegreza|Aluysio|Andrea|Arizzo|Ascelina|Aya) ("..citizenspeaks..")"
    ...
    ,"(Ienobu) ("..citizenemotes..")"
    ,"(Ienobu) ("..citizenspeaks..")"
