...
local function showHelpBase(args)
    ...
    cecho(preText.."/track <option> [share]          - Command line control of the tracking system\n")
...
local function showHelpTracking(args)
	...
	cecho(preHead.."DARTMUDLET: track tracking\n")
	cecho(preHead.."USAGE: /track <name|on|off|toggle|reset> [share]\n")
    cecho(preText.."\n")
    cecho(preText.."NAME: Displays detailed statistics for skills gained while tracking system is active.\n")
    cecho(preText.."This can be for the player or for any pets that gained skills during this time. You\n")
    cecho(preText.."can include the word 'share' after the name to share the detailed stats to the room.\n")
	cecho(preText.."\n")
